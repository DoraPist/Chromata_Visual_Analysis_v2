...
# This code receives input request for the dance-recognition service and saves them to the MongoDB

# Connect to redis
topic = "dance-recognition"
...
print("[INFO] Dance-recognition waits for a message...")
...
while True:
    ...
    if message:
        ...
        if message and type(message['data']) is bytes:
            ...
            db.ImagesDB.Chromata_InputQueue_DR.insert_one(input_data)
            print("[INFO] Message is saved in MongoDB")

        print("\n[INFO] Dance-recognition waits for a message...")
